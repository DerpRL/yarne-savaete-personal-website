...
import { WorkHistoryMetaData } from "@/utils/types";
import { PaperAirplaneIcon } from "@heroicons/react/24/solid";


export const WorkHistoryElement: FC<WorkHistoryMetaData> = ({ placeName, description, location, beginDate, endDate, isLastElement }) => {
    return (
        <>
            <div className={'flex flex-row-start items-start ml-2 my-2 relative'}>
                ...
                <div className={'flex flex-col items-start pl-8'}>
                    <div className={'flex flex-col items-start'}>
                        <h4 className={'text-black text-xl'}>{ placeName }</h4>
                    ...
                    <p className={'w-full lg:min-w-9/12 xl:min-w-1/2'}>{ description }</p>
                </div>
            </div>
        </>
    )
