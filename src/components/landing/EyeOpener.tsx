...
export const EyeOpener = () => {
    return (
        <div className={'flex flex-col min-[1350px]:flex-row items-center justify-between w-full my-8 md:my-24'}>
            <div className={'mr-6 min-[1350px]:mr-0 animate-text-reveal'}>
                <div className={'animate-text-reveal flex flex-col'}>
                ...
                <div className={'flex flex-row justify-evenly min-[1350px]:justify-start items-center mt-4 animate-text-reveal'}>
                ...
                <div className={'flex flex-row items-center min-[1350px]:justify-start justify-evenly my-6 min-[1350px]:mt-12 animate-text-reveal'}>
                    ...
                    <Link href={'https://github.com/DerpRL'} target={'_blank'}>
                        <Image src={'/assets/images/GitHub_Icon.png'} alt={'LinkedIn Website Icon'} className={'min-[1350px]:mr-3 motion-safe:hover:scale-110 transition-all duration-300 ease-in-out'} height={25} width={25}/>
                    </Link>
                    <Link href={'https://www.instagram.com/yarnesavaete/'} target={'_blank'}>
                        <Image src={'/assets/images/Instagram_Icon.png'} alt={'LinkedIn Website Icon'} className={'min-[1350px]:mr-3 motion-safe:hover:scale-110 transition-all duration-300 ease-in-out'} height={25} width={25}/>
                    </Link>
                    <Link href={'https://www.facebook.com/yarne.savaete'} target={'_blank'}>
                    ...
                    <Link href={'https://twitter.com/yarne_savaete'} target={'_blank'}>
                        <Image src={'/assets/images/Twitter_Icon.png'} alt={'LinkedIn Website Icon'} className={'motion-safe:hover:scale-110 transition-all duration-300 ease-in-out'} height={25} width={25}/>
                    </Link>
                </div>
            </div>
            <Image className={'max-w-full animate-text-reveal'} src={'/assets/images/profile-background.png'} alt={'Background image for the profile picture.'} height={600} width={750} priority={true}/>
        </div>
    )
}
